                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <table class="table table-bordered">
                        ...
                        while ($tot_score_row = $tot_score_query->fetch()) {
                          $totx_score = $totx_score + (int) $tot_score_row['total_score'];
                          ?>
                ...
                while ($jjn_result_row = $jjn_result_query->fetch()) {
                  ...
                  <td>
                    <table>
                      <tr>
                        <td align="center">
                          &nbsp;&nbsp;&nbsp;<u><strong><?php echo $jname_row['fullname']; ?></strong></u>&nbsp;&nbsp;&nbsp;
                        </td>
                      </tr>
                      <tr>
                ...
                while ($jjn_result_row = $jjn_result_query->fetch()) {
                  ...
                  <td>
                    <table>
                      <tr>
                        <td align="center">
                          &nbsp;&nbsp;&nbsp;<u><strong><?php echo $jjn_result_row['fname'] . " " . $jjn_result_row['mname'] . " " . $jjn_result_row['lname']; ?></strong></u>&nbsp;&nbsp;&nbsp;
                        </td>
                      </tr>
                      <tr>
