...
<body>
   ...
   <div class="container">
      ...
      <div class="col-lg-12">
         ...
         <a href="department.php" class="btn btn-info"><strong>MANAGE DEPARTMENT &raquo;</strong></a>
                     ...
                     while ($row = $query->fetch()) { ?>
                        ...
                        <table align="center">
                           ...
                           <tr>
                              <td>
                                 ...
                                 <input type="text" name="fname" class="form-control" placeholder="Firstname"
                                    value="<?php echo $row['fname']; ?>" aria-describedby="basic-addon1" required
                                    autofocus>
                              </td>
                              <td>&nbsp;</td>
                              <td>
                                 ...
                                 <input type="text" name="mname" class="form-control" placeholder="Middlename"
                                    value="<?php echo $row['mname']; ?>" aria-describedby="basic-addon1" required
                                    autofocus>
                              </td>
                              <td>&nbsp;</td>
                              <td>
                                 ...
                                 <input type="text" name="lname" class="form-control" placeholder="Lastname"
                                    value="<?php echo $row['lname']; ?>" aria-describedby="basic-addon1" required
                                    autofocus>
                              </td>
                           </tr>
                           ...
                           <tr>
                              ...
                              <td>
                                 ...
                                 <input type="text" name="pnum" class="form-control" placeholder="Phone Number"
                                    value="<?php echo $row['pnum']; ?>" aria-describedby="basic-addon1" required autofocus>
                              </td>
                              <td>&nbsp;</td>
                              <td>
                              </td>
                           ...
                           <tr>
                              <td colspan="5">
                                 ...
                                 <input type="text" name="cname" class="form-control" placeholder="Company Name"
                                    value="<?php echo $row['company_name']; ?>" aria-describedby="basic-addon1" required
                                    autofocus>
                              </td>
                           </tr>
                           ...
                           <tr>
                              <td colspan="5">
                                 Company Address:
                                 <input type="text" name="caddress" class="form-control" placeholder="Company Address"
                                    value="<?php echo $row['company_address']; ?>" aria-describedby="basic-addon1" required
                                    autofocus>
                              </td>
                           </tr>
                           ...
                           <tr>
                              <td>
                                 Telephone:
                                 <input type="text" name="ctelephone" class="form-control" placeholder="Company Telephone"
                                    value="<?php echo $row['company_telephone']; ?>" aria-describedby="basic-addon1"
                                    required autofocus>
                              </td>
                              <td>&nbsp;</td>
                              <td>
                                 ...
                                 <input type="text" name="cemail" class="form-control" placeholder="Company Email"
                                    value="<?php echo $row['company_email']; ?>" aria-describedby="basic-addon1" required
                                    autofocus>
                              </td>
                              <td>&nbsp;</td>
                              <td>
                                 Website:
                                 <input type="text" name="cwebsite" class="form-control" placeholder="Company Website"
                                    value="<?php echo $row['company_website']; ?>" aria-describedby="basic-addon1" required
                                    autofocus>
                              </td>
                           </tr>
                     ...
                     <div class="col-lg-6">
                        ...
                        <table align="center">
                           ...
                           <tr>
                              <td colspan="2">
                                 <br />
                                 <img class="thumbnail" src="uploads/<?php echo $row['company_logo']; ?>" width="100"
                                    height="100" />
                           ...
                           <tr>
                              <td>
                                 ...
                                 <input type="text" name="username" class="form-control" placeholder="Username"
                                    value="<?php echo $row['username']; ?>" aria-describedby="basic-addon1" required
                                    autofocus>
                              </td>
                              <td>&nbsp;</td>
                              <td>
                                 Password:
                                 <input id="password" type="password" name="passwordx" class="form-control"
                              ...
                              <td>
                                 Re-type Password:
                                 <input id="confirm_password" type="password" name="password2x" class="form-control"
                                    placeholder="Re-type Password" value="<?php echo $row['password']; ?>"
                                    aria-describedby="basic-addon1" required autofocus>
