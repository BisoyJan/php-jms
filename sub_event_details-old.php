            ...
            <div id="main">
              ...
              <div class="my-form">
                ...
                <p class="text-box">
                  ...
                  <input type="hidden" value="<?php echo rand(100000, 999999); ?>" name="rand1" value="" id="box2"
                    required="true" />
      ...
      <div id="footer">
        ...
        <table>
          <tr>
            ...
            <td>&nbsp;</td>
            <td><button name="save_settings" id="submit" type="submit" class="btn btn-primary">Save Settings</button>
            </td>
          </tr>
        </table>
