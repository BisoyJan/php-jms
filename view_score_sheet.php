                  ...
                  while ($score_row = $score_query->fetch()) {
                    ...
                    <tr>
                      ...
                      while ($cont_row = $cont_query->fetch()) {
                        ...
                        $department_id = $cont_row['department_id'];
                        $category = $cont_row['category']; // Fetch category
                        echo $c_num . ". " . $cfnme = $cont_row['fullname'];
                      }

                      ?></td>

                      <td><?php echo $category; ?></td> <!-- Display category -->

                      <td><?php
                      // Fetch department name
                      $dept_query = $conn->query("select * from dapartment where department_id='$department_id'") or die(mysql_error());
                      while ($dept_row = $dept_query->fetch()) {
                        echo $dept_row['department'];
                      }
                      ?></td>
